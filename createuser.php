...
?>
        ...
        <h2 class="text-center pt-4" style="color :#ff4d05 ;">Create a User</h2>
        <br>
        ...
        <div class="screen-body-item">
          <form class="app-form" method="post">
            ...
            <div class="app-form-group button">
              <input class="app-form-button" style="color:fff;" type="submit" value="CREATE USER" name="submit"></input>
...
<p>&copy 2023 Made by <b>Narendra Singh </b>Under The Guidence of <b><a href="https://internship.thesparksfoundation.info/" >The Spark Foundation</a></b></p>
      </footer>
